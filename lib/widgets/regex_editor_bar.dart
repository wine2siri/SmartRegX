  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(top: BorderSide(color: t.shadowLight.withOpacity(0.3), width: 1)),
        boxShadow: [
          BoxShadow(color: t.shadowLight.withOpacity(0.2), offset: const Offset(0, -2), blurRadius: 6),
        ],
      ),
      child: Column(
        ...
        children: [
          if (widget.regex.isNotEmpty && !isValid)
            Container(
              ...
              decoration: BoxDecoration(
                color: t.errorColor.withOpacity(0.08),
                borderRadius: const BorderRadius.vertical(top: Radius.circular(20)),
              ),
              child: Text(
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: t.raisedButton(radius: 8),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
